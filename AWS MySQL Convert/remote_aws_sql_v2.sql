...
INSERT INTO `auth_permission` (`id`, `content_type_id`, `codename`, `name`) VALUES
	...
	(133, 35, 'add_article', 'Can add article'),
	(134, 35, 'change_article', 'Can change article'),
	(135, 35, 'delete_article', 'Can delete article'),
	(136, 35, 'view_article', 'Can view article'),
	(137, 36, 'add_service', 'Can add service'),
	(138, 36, 'change_service', 'Can change service'),
	(139, 36, 'delete_service', 'Can delete service'),
	(140, 36, 'view_service', 'Can view service'),
	(141, 34, 'add_setting', 'Can add setting'),
	(142, 34, 'change_setting', 'Can change setting'),
	(143, 34, 'delete_setting', 'Can delete setting'),
	(144, 34, 'view_setting', 'Can view setting'),
	(145, 37, 'add_page', 'Can add page'),
	(146, 37, 'change_page', 'Can change page'),
	(147, 37, 'delete_page', 'Can delete page'),
	(148, 37, 'view_page', 'Can view page');
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`, `first_name`) VALUES
	(1, 'pbkdf2_sha256$720000$wd3vmPE6E5Uwicjrs8xCDP$e945v0yLYBEEX4r12Q5sBBgBpJGQuEKV4dyaU7hkO9k=', '2024-01-13 17:49:07', 'True', 'admin', '', 'info@emrahyuksel.com.tr', 'True', 'True', '2023-12-31 12:05:51', '');
...
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES
	...
	(61, '1', 'Setting object (1)', 2, '[{"changed": {"fields": ["Logo 01"]}}]', 34, 1, '2024-01-13 17:49:41'),
	(62, '1', 'Blog 01', 2, '[{"changed": {"fields": ["G\\u00f6rsel", "Tags"]}}]', 24, 1, '2024-01-13 17:50:10'),
	(63, '1', 'Duyuru 01', 1, '[{"added": {}}]', 33, 1, '2024-01-13 18:03:34');
...
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	...
	(96, 'tcore', '0002_article_content', '2024-01-13 17:51:25'),
	(97, 'tcore', '0003_delete_article', '2024-01-13 17:51:25'),
	(98, 'tcore', '0004_initial', '2024-01-13 17:51:25'),
	(99, 'tcore', '0005_about', '2024-01-13 17:51:25'),
	(100, 'tcore', '0006_about_content_en_about_content_tr_about_title_en_and_more', '2024-01-13 17:51:25'),
	(101, 'tcore', '0007_service', '2024-01-13 17:51:25'),
	(102, 'tcore', '0008_slider', '2024-01-13 17:51:25'),
	(103, 'tcore', '0009_category_blog', '2024-01-13 17:51:25'),
	(104, 'tcore', '0010_setting_alter_blog_image_alter_category_slug', '2024-01-13 17:51:25'),
	(105, 'tcore', '0011_blog_tags_alter_about_content_alter_about_content_en_and_more', '2024-01-13 17:51:25'),
	(106, 'tcore', '0012_page', '2024-01-13 17:51:25'),
	(107, 'tcore', '0013_announcement', '2024-01-13 18:03:13');
...
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	...
	('h52kfnfiu60l2xxn6b6jje8resiqnqij', '.eJxVjDsOwjAQBe_iGln-yVko6TmDtev14gBypDipEHdHllJA-2bmvVXCfatp72VNM6uLsur0uxHmZ2kD8APbfdF5ads6kx6KPmjXt4XL63q4fwcVex01WeOZKWKEyUr0AjAFC8LeOUQkoMglQPQFUZwVMibkM7og4HPI6vMF9xA4hQ:1rOi83:GqF0-PYZynerZ2PTBczTNHpqVGLmBa1tK-KimA_-wC8', '2024-01-27 17:49:07');
...
CREATE TABLE IF NOT EXISTS `tcore_announcement` (
  ...
  `title_tr` varchar(200) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `title_en` varchar(200) COLLATE utf8mb4_turkish_ci DEFAULT NULL,
  `content` longtext COLLATE utf8mb4_turkish_ci NOT NULL,
  `content_tr` longtext COLLATE utf8mb4_turkish_ci,
  `content_en` longtext COLLATE utf8mb4_turkish_ci,
...
INSERT INTO `tcore_announcement` (`id`, `title`, `title_tr`, `title_en`, `content`, `content_tr`, `content_en`, `created_at`, `updated_at`) VALUES
	(1, 'Duyuru 01', 'Duyuru 01', NULL, '<p>Duyuru 01 İ&ccedil;erik</p>', '<p>Duyuru 01 İ&ccedil;erik</p>', '', '2024-01-13 18:03:33.607882', '2024-01-13 18:03:33.607882');
...
CREATE TABLE IF NOT EXISTS `tcore_page` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `title` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `title_tr` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `title_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `content_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `slug` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  UNIQUE KEY `pk_tcore_page` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `tcore_page` (`id`, `title`, `title_tr`, `title_en`, `content`, `content_tr`, `content_en`, `slug`) VALUES
...
CREATE TABLE IF NOT EXISTS `tcore_service` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `title` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `title_tr` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `title_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `content_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `slug` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  UNIQUE KEY `pk_tcore_service` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `tcore_service` (`id`, `title`, `title_tr`, `title_en`, `content`, `content_tr`, `content_en`, `slug`) VALUES
...
CREATE TABLE IF NOT EXISTS `tcore_setting` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `pk_tcore_setting` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `tcore_setting` (`id`, `logo_1`, `logo_2`, `title`, `title_tr`, `title_en`, `description`, `description_tr`, `description_en`, `keywords`, `keywords_tr`, `keywords_en`, `phone_fixed`, `phone_mobile`, `fax`, `email`, `city`, `district`, `address`, `postal_code`, `facebook_url`, `twitter_url`, `instagram_url`, `youtube_url`) VALUES
	(1, 'dimg/logo_LTmsFU4.png', 'dimg/logo_AnxHF6P.png', 'Corporate V1 Edukey Kurumsal Internet Sitesi', 'Corporate V1 Edukey Kurumsal Internet Sitesi', 'Corporate V1 Edukey Corporate Website', 'Corporate V1 Edukey Kurumsal İnternet Sitesi Emrah Yüksel tarafından Django eğitimine özel olarak hazırlanmıştır.', 'Corporate V1 Edukey Kurumsal İnternet Sitesi Emrah Yüksel tarafından Django eğitimine özel olarak hazırlanmıştır.', 'Corporate V1 Edukey Corporate Website was prepared by Emrah Yüksel specifically for Django training.', 'corporate, edukey, emrahyuksel', 'corporate, edukey, emrahyuksel', 'corporate, edukey, emrahyuksel', '2122121212', '2122121212', '2122121212', 'info@emrahyuksel.com.tr', 'Istanbul', 'Fatih', 'Adres verisi Istanbul Fatih', '34400', 'https://www.facebook.com', 'https://www.twitter.com', 'https://www.instagram.com', 'https://www.youtube.com');
